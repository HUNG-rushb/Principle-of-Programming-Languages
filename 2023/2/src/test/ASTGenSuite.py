...
########################################
    ...
    def test_205(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([ForStmt(AssignStmt(Id(i), IntegerLit(1)), BinExpr(<, Id(j), IntegerLit(10)), BinExpr(+, Id(i), IntegerLit(1)), BlockStmt([CallStmt(printInteger, )]))]))
])"""
        self.assertTrue(TestAST.test(input, expect, 300))
    ...
    def test_295(self):
        ...
        '''
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([VarDecl(s, BooleanType), CallStmt(readBoolean, Id(s))]))
])"""
