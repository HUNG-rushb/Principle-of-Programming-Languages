...
class ASTGenSuite(unittest.TestCase):
    ...
    #     Class A {
    #         foo() {
    #            Var a, ab: Boolean = True, True;
    #         }
    #     }
    #         """
    #     expect = """Program([ClassDecl(Id(A),[MethodDecl(Id(foo),Instance,[],Block([AttributeDecl(Instance,ConstDecl(Id(a),BoolType,BoolType)),AttributeDecl(Instance,ConstDecl(Id(a),BoolType,BoolType))]))])])"""
